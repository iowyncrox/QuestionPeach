...
public class _Super_CustomDatatype extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
     ...
     * properties
     */
    private var _internal_PARENT_TASK_ID : Object;
    ...
    public function _Super_CustomDatatype()
    {
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "PARENT_TASK_ID", model_internal::setterListenerPARENT_TASK_ID));
    ...
    public function get PARENT_TASK_ID() : Object
    {
    ...
    public function set PARENT_TASK_ID(value:Object) : void
    {
        var oldValue:Object = _internal_PARENT_TASK_ID;
        if (oldValue !== value)
        {
    ...
    model_internal function setterListenerPARENT_TASK_ID(value:flash.events.Event):void
    {
        _model.invalidateDependentOnPARENT_TASK_ID();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.PARENT_TASK_IDIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_PARENT_TASK_IDValidationFailureMessages);
        }
    ...
    model_internal var _doValidationCacheOfPARENT_TASK_ID : Array = null;
    model_internal var _doValidationLastValOfPARENT_TASK_ID : Object;

    model_internal function _doValidationForPARENT_TASK_ID(valueIn:Object):Array
    {
        var value : Object = valueIn as Object;

        if (model_internal::_doValidationCacheOfPARENT_TASK_ID != null && model_internal::_doValidationLastValOfPARENT_TASK_ID == value)
           return model_internal::_doValidationCacheOfPARENT_TASK_ID ;

        _model.model_internal::_PARENT_TASK_IDIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isPARENT_TASK_IDAvailable && _internal_PARENT_TASK_ID == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "PARENT_TASK_ID is required"));
        }

        model_internal::_doValidationCacheOfPARENT_TASK_ID = validationFailures;
        model_internal::_doValidationLastValOfPARENT_TASK_ID = value;
