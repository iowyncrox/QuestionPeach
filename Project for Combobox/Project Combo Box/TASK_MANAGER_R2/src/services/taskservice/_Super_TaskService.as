...
internal class _Super_TaskService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{
    ...
    public function _Super_TaskService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "getAssignTo");
         operation.resultElementType = valueObjects.CustomDatatype2;
        operations["getAssignTo"] = operation;
        ...
        operation = new mx.rpc.remoting.Operation(null, "AssignToPersonCombo");
         operation.resultType = int;
        operations["AssignToPersonCombo"] = operation;
        ...
        dmQuery = new mx.data.ManagedQuery("createTask");
        dmQuery.propertySpecifier = "TASK_ID,PARENT_TASK_ID,priority_nr,SHORT_TITLE_TX,SHORT_DESCRIPTION_TX,LONG_DESCRIPTION_TX,DEADLINE_DT,ESTIMATED_COMPLETION_DT,COMPLETION_DT,RECIPIENT_PERSON_ID,ASSIGNED_ORGANIZATION_ID,ASSIGNED_TO_PERSON_ID,ASSIGNED_BY_PERSON_ID,CREATED_BY_USER_NM,CREATED_DTTM,LAST_UPDATED_BY_USER_NM,LAST_UPDATED_DTTM";
        dmQuery.parameters = "item";
        _taskRPCDataManager.addManagedOperation(dmQuery);
    ...
    /**
      * This method is a generated wrapper used to call the 'getAssignTo' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getAssignTo() : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getAssignTo");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send() ;
        return _internal_token;
    }
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function StringToIntPriority(item:String) : mx.rpc.AsyncToken
    {
    ...
    /**
      * This method is a generated wrapper used to call the 'AssignToPersonCombo' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function AssignToPersonCombo(item:String) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("AssignToPersonCombo");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(item) ;
        return _internal_token;
    }
