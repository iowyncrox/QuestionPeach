...
public class _Super_Organization extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    private var _internal_PARENT_ORGANIZATION_ID : int;
    private var _internal_ORGANIZATION_NM : String;
    private var _internal_ORGANIZATION_SHORT_TITLE_TX : String;
    ...
    [Bindable(event="propertyChange")]
    public function get PARENT_ORGANIZATION_ID() : int
    {
        return _internal_PARENT_ORGANIZATION_ID;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get ORGANIZATION_SHORT_TITLE_TX() : String
    {
        return _internal_ORGANIZATION_SHORT_TITLE_TX;
    }
    ...
    public function set PARENT_ORGANIZATION_ID(value:int) : void
    {
        var oldValue:int = _internal_PARENT_ORGANIZATION_ID;
        if (oldValue !== value)
        {
            _internal_PARENT_ORGANIZATION_ID = value;
        }
    }
    ...
    public function set ORGANIZATION_SHORT_TITLE_TX(value:String) : void
    {
        var oldValue:String = _internal_ORGANIZATION_SHORT_TITLE_TX;
        if (oldValue !== value)
        {
            _internal_ORGANIZATION_SHORT_TITLE_TX = value;
        }
    }
