 ...
 * of this value object you may modify the generated sub-class of this class - Priority_lookup.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Priority_lookup extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _Priority_lookupEntityMetadata;
    ...
    private var _internal_PRIORITY_DESCRIPTION_TX : String;
    ...
    public function _Super_Priority_lookup()
    {
        _model = new _Priority_lookupEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get PRIORITY_DESCRIPTION_TX() : String
    {
        return _internal_PRIORITY_DESCRIPTION_TX;
    }
    ...
    public function set PRIORITY_DESCRIPTION_TX(value:String) : void
    {
        var oldValue:String = _internal_PRIORITY_DESCRIPTION_TX;
        if (oldValue !== value)
        {
            _internal_PRIORITY_DESCRIPTION_TX = value;
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Priority_lookupEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Priority_lookupEntityMetadata) : void
    {
        var oldValue : _Priority_lookupEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
