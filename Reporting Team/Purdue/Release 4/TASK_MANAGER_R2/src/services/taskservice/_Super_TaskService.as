...
internal class _Super_TaskService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{
    ...
    public function _Super_TaskService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "getTASKByPriority");
         operation.resultType = valueObjects.Task;
        operations["getTASKByPriority"] = operation;
        ...
        dmQuery = new mx.data.ManagedQuery("getTASKByPriority");
        dmQuery.propertySpecifier = "TASK_ID,PARENT_TASK_ID,PRIORITY_NR,SHORT_TITLE_TX,SHORT_DESCRIPTION_TX,LONG_DESCRIPTION_TX,DEADLINE_DT,ESTIMATED_COMPLETION_DT,COMPLETION_DT,RECIPIENT_PERSON_ID,ASSIGNED_ORGANIZATION_ID,ASSIGNED_TO_PERSON_ID,ASSIGNED_BY_PERSON_ID,CREATED_BY_USER_NM,CREATED_DTTM,LAST_UPDATED_BY_USER_NM,LAST_UPDATED_DTTM";
        dmQuery.parameters = "itemID";
        dmQuery.type="findItem";
        _taskRPCDataManager.addManagedOperation(dmQuery);

        dmQuery = new mx.data.ManagedQuery("getTASKByID");
        dmQuery.propertySpecifier = "TASK_ID,PARENT_TASK_ID,PRIORITY_NR,SHORT_TITLE_TX,SHORT_DESCRIPTION_TX,LONG_DESCRIPTION_TX,DEADLINE_DT,ESTIMATED_COMPLETION_DT,COMPLETION_DT,RECIPIENT_PERSON_ID,ASSIGNED_ORGANIZATION_ID,ASSIGNED_TO_PERSON_ID,ASSIGNED_BY_PERSON_ID,CREATED_BY_USER_NM,CREATED_DTTM,LAST_UPDATED_BY_USER_NM,LAST_UPDATED_DTTM";
        dmQuery.parameters = "itemID";
        dmQuery.type="findItem";
        _taskRPCDataManager.addManagedOperation(dmQuery);
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getTASKByID(itemID:Object) : mx.rpc.AsyncToken
    {
    ...
    /**
      * This method is a generated wrapper used to call the 'getTASKByPriority' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getTASKByPriority(itemID:Object) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getTASKByPriority");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(itemID) ;
        return _internal_token;
    }
